 ...
 * @ORM\Entity(repositoryClass="Ezap\PublicBundle\Repository\MoviesRepository")
 */
class Movies
{
    /**
     ...
     * Add comments
     *
     * @param \Ezap\PublicBundle\Entity\Comments $comments
     * @return Movies
     */
    public function addComment(\Ezap\PublicBundle\Entity\Comments $comments)
    {
     ...
     * @param \Ezap\PublicBundle\Entity\Comments $comments
     */
    public function removeComment(\Ezap\PublicBundle\Entity\Comments $comments)
    {
