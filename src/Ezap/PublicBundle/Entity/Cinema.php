 ...
 * @ORM\Entity(repositoryClass="Ezap\PublicBundle\Repository\CinemaRepository")
 */
class Cinema
{
    /**
     ...
     * Add sessions
     *
     * @param \Ezap\PublicBundle\Entity\Sessions $sessions
     * @return Cinema
     */
    public function addSession(\Ezap\PublicBundle\Entity\Sessions $sessions)
    {
     ...
     * @param \Ezap\PublicBundle\Entity\Sessions $sessions
     */
    public function removeSession(\Ezap\PublicBundle\Entity\Sessions $sessions)
    {
