 ...
 * @ORM\Entity
 * @ORM\Table(name="user")
 * @ORM\Entity(repositoryClass="Ezap\PublicBundle\Repository\UserRepository")
 */
class User extends BaseUser
{
     ...
     * Add favorites
     *
     * @param \Ezap\PublicBundle\Entity\Movies $favorites
     * @return User
     */
    public function addFavorite(\Ezap\PublicBundle\Entity\Movies $favorites)
    {
     ...
     * @param \Ezap\PublicBundle\Entity\Movies $favorites
     */
    public function removeFavorite(\Ezap\PublicBundle\Entity\Movies $favorites)
    {
