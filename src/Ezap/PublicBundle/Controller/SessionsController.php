...
use Ezap\PublicBundle\Entity\Sessions;
use Ezap\PublicBundle\Form\SessionsType;
...
class SessionsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EzapPublicBundle:Sessions')->findAll();

        return $this->render('EzapPublicBundle:Sessions:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EzapPublicBundle:Sessions:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EzapPublicBundle:Sessions')->find($id);
        ...
        return $this->render('EzapPublicBundle:Sessions:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EzapPublicBundle:Sessions:edit.html.twig', array(
            'entity'      => $entity,
