...
use Ezap\PublicBundle\Entity\Tags;
use Ezap\PublicBundle\Form\TagsType;
...
class TagsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EzapPublicBundle:Tags')->findAll();

        return $this->render('EzapPublicBundle:Tags:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EzapPublicBundle:Tags:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EzapPublicBundle:Tags')->find($id);
        ...
        return $this->render('EzapPublicBundle:Tags:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EzapPublicBundle:Tags:edit.html.twig', array(
            'entity'      => $entity,
