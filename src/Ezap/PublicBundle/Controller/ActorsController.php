...
use Ezap\PublicBundle\Entity\Actors;
use Ezap\PublicBundle\Form\ActorsType;
...
class ActorsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EzapPublicBundle:Actors')->findAll();

        return $this->render('EzapPublicBundle:Actors:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EzapPublicBundle:Actors:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EzapPublicBundle:Actors')->find($id);
        ...
        return $this->render('EzapPublicBundle:Actors:show.html.twig', array(
            'entity'      => $entity,
            'movies'      => $pagination,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EzapPublicBundle:Actors:edit.html.twig', array(
            'entity'      => $entity,
