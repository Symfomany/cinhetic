...
--
-- Client: localhost
-- Généré le: Lun 07 Avril 2014 à 19:06
...
INSERT INTO `medias` (`id`, `nature`, `picture`, `video`) VALUES
(1, 1, 'http://images2.alphacoders.com/284/284450.jpg', NULL),
(2, 1, 'http://jolstatic.fr/www/captures/1885/4/53684.jpg', NULL),
(3, 1, 'http://series-parlotte.eu/ressources/images/Film/LeSeigneurDesAnneaux_LaCommunauteDeLAnneau.jpg', NULL),
(4, 1, 'http://image.toutlecine.com/photos/s/e/i/seigneur-des-anneaux-1-05-g.jpg', NULL),
(5, 1, 'http://p3.storage.canalblog.com/33/97/847944/70005341.jpg', NULL),
(6, 1, 'http://mondesimaginaires.m.o.pic.centerblog.net/725muiyh.jpg', NULL),
(7, 2, '', '<iframe width="560" height="315" src="//www.youtube.com/embed/nalLU8i4zgs" frameborder="0" allowfullscreen></iframe>'),
(8, 2, NULL, '<iframe width="560" height="315" src="//www.youtube.com/embed/tyQ2n6W78PM" frameborder="0" allowfullscreen></iframe>'),
(9, 2, NULL, '<iframe width="420" height="315" src="//www.youtube.com/embed/BEm0AjTbsac" frameborder="0" allowfullscreen></iframe>');

-- --------------------------------------------------------

--
-- Structure de la table `medias_movies`
--

CREATE TABLE IF NOT EXISTS `medias_movies` (
  `movies_id` int(11) NOT NULL,
...
--
-- Contenu de la table `medias_movies`
--

INSERT INTO `medias_movies` (`movies_id`, `medias_id`) VALUES
(1, 1),
(1, 2),
(2, 3),
(2, 4),
...
(2, 'julien@meetserious.com', 'julien', 'paOTOYatQy9M50y4wYEf5OJNAfu12f0yed++gl7maL9buXWpE8OUi5SakZCm2jnd0q7REJUVmspxvmrqo4scrg==', 'Lyon', 69005, '0674585648', '127.0.0.1', 1, '2014-04-07 20:31:54', 0, 0, 'julien', 'julien@meetserious.com', 'btel3h204q8swo8gwswkkosgk08s480', NULL, NULL, NULL, 'a:0:{}', NULL, NULL, NULL, 0, NULL, '2014-04-03 10:27:30', '2014-04-03 10:27:30');
...
--
-- Contraintes pour la table `medias_movies`
--
ALTER TABLE `medias_movies`
  ADD CONSTRAINT `medias_movies_ibfk_1` FOREIGN KEY (`movies_id`) REFERENCES `movies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `medias_movies_ibfk_2` FOREIGN KEY (`medias_id`) REFERENCES `medias` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
