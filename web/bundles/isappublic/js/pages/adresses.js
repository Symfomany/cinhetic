...
var collectionHolder2 = $('div.addresses');

// ajoute un lien « add a tag »
var $addTagLink2 = $('<a class="btn btn-primary addcaracteristiques"><i class="glyphicon glyphicon-plus"></i> Ajouter une adresse</a>');
...
function addTagForm2DeleteLink2($tagFormLi) {
    var $removeFormA = $('<a class="btn btn-primary addcaracteristiques"><i class="glyphicon glyphicon-minus"></i> Supprimer cette adresse</a>');
